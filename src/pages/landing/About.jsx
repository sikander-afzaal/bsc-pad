          ...
          <div className="flex justify-start items-start flex-col gap-4">
            <div>
              ...
              <h3 className="text-lg font-medium text-textGray ">
                The sth Launch Pad is the first decentralized IDO platform for
            ...
            <div>
              ...
              <h3 className="text-lg font-medium text-textGray ">
                sthPad has found a solution to incentivize and reward all token
                stakers in a way that is inclusive and with a low barrier to
                entry.
              </h3>
              <p className="text-base text-white text-opacity-60">
                ...
                matter of seconds. sthPad is creating fair decentralized
              ...
              <p className="text-base text-white text-opacity-60">
                The hallmark of the sthPad is a two-round system that makes
